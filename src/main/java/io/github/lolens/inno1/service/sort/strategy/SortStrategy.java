package io.github.lolens.inno1.service.sort.strategy;

import io.github.lolens.inno1.entity.NumericArrayWrapper;
import io.github.lolens.inno1.service.sort.strategy.impl.BubbleSortStrategy;
import io.github.lolens.inno1.service.sort.strategy.impl.InsertionSortStrategy;
import io.github.lolens.inno1.service.sort.strategy.impl.SelectionSortStrategy;
